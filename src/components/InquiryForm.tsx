  ...
  return (
    <div>
      <div className="flex flex-wrap gap-3 mb-4">
        <span className="flex items-center gap-1 text-xs text-[#1e782d] font-medium"><span>✓</span> 入力3分で完了</span>
        <span className="flex items-center gap-1 text-xs text-[#1e782d] font-medium"><span>✓</span> 返信は24時間以内</span>
        <span className="flex items-center gap-1 text-xs text-[#1e782d] font-medium"><span>✓</span> 無料で相談できます</span>
      </div>
