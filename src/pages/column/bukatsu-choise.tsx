          ...
          <SubSection title="運動部">
            <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, border: "1px solid #e0e7ff", mb: 2 }}>
              <List>
                <ListItem disablePadding sx={{ mb: 1.5 }}>
                  <Box>
                    <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>野球・サッカー・バレーボール</Typography>
                    <Typography variant="body2" sx={{ color: "#424242" }}>
                ...
                <ListItem disablePadding sx={{ mb: 1.5 }}>
                  <Box>
                    <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>テニス・陸上・水泳</Typography>
                    <Typography variant="body2" sx={{ color: "#424242" }}>
                ...
                <ListItem disablePadding>
                  <Box>
                    <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>剣道・柔道・弓道</Typography>
                    <Typography variant="body2" sx={{ color: "#424242" }}>
