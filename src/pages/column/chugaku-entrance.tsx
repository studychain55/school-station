          ...
          <TableContainer>
            <Table sx={{ border: "1px solid #E0E0E0" }}>
              <TableHead sx={{ bgcolor: "#F5F5F5" }}>
                <TableRow>
                  <TableCell sx={{ fontWeight: 700, color: "#4f46e5" }}>費用項目</TableCell>
                  <TableCell sx={{ fontWeight: 700, color: "#4f46e5" }}>説明</TableCell>
                  <TableCell sx={{ fontWeight: 700, color: "#4f46e5", textAlign: "right" }}>総額</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr" }, gap: 2 }}>
            <Paper sx={{ p: 3, bgcolor: "#e0e7ff", border: "1px solid #e0e7ff" }}>
              <Typography sx={{ fontWeight: 700, color: "#4f46e5", mb: 1 }}>
                4月～11月：塾での受験対策期間
              </Typography>
            ...
            <Link href="/column/hensachi-guide/" style={{ textDecoration: "none" }}>
              <Paper
                ...
                sx={{
                  ...
                  transition: "all 0.2s",
                  "&:hover": { boxShadow: "0 4px 8px rgba(0,0,0,0.1)", borderColor: "#4f46e5" },
                }}
              >
                <Typography sx={{ fontWeight: 600, color: "#4f46e5", mb: 1 }}>
                  偏差値の見方・使い方を徹底解説
                </Typography>
                <Typography variant="body2" sx={{ color: "#424242" }}>
                  偏差値とは何か、受験戦略にどう活かすか
          ...
          <Link href="/column/" style={{ textDecoration: "none" }}>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1 }}>
                <ArrowBackIcon sx={{ fontSize: "1.2rem", color: "#4f46e5" }} />
