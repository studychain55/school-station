    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Paper sx={{ p: { xs: 2, sm: 3 }, mb: 4, bgcolor: "#F9F9F9", border: "1px solid #E0E0E0" }}>
          <Typography variant="h3" component="h3" sx={{ fontSize: "1.1rem", fontWeight: 600, mb: 2, color: "#4f46e5" }}>
            目次
          </Typography>
          <List sx={{ pl: 2 }}>
            <ListItem disablePadding sx={{ mb: 0.5 }}>
              <ListItemIcon sx={{ minWidth: 32 }}>
                <CheckCircleIcon sx={{ color: "#4f46e5", fontSize: "1.2rem" }} />
              </ListItemIcon>
              <Link href="#grade1" style={{ textDecoration: "none", color: "#4f46e5" }}>
            ...
            <ListItem disablePadding sx={{ mb: 0.5 }}>
              ...
              <Link href="#grade2" style={{ textDecoration: "none", color: "#4f46e5" }}>
                <Typography variant="body2" sx={{ cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
            ...
            <ListItem disablePadding sx={{ mb: 0.5 }}>
              ...
              <Link href="#grade3" style={{ textDecoration: "none", color: "#4f46e5" }}>
                <Typography variant="body2" sx={{ cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
            ...
            <ListItem disablePadding sx={{ mb: 0.5 }}>
              ...
              <Link href="#suisen" style={{ textDecoration: "none", color: "#4f46e5" }}>
                <Typography variant="body2" sx={{ cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
                  推薦入試・総合型選抜の対策戦略
                </Typography>
              </Link>
            ...
            <ListItem disablePadding sx={{ mb: 0.5 }}>
              ...
              <Link href="#general" style={{ textDecoration: "none", color: "#4f46e5" }}>
                <Typography variant="body2" sx={{ cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
                  一般入試の基礎固めと実践対策
                </Typography>
              </Link>
            ...
            <ListItem disablePadding sx={{ mb: 0.5 }}>
              ...
              <Link href="#mock" style={{ textDecoration: "none", color: "#4f46e5" }}>
                <Typography variant="body2" sx={{ cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
                  模試の活用法と偏差値の読み方
                </Typography>
              </Link>
            ...
            <ListItem disablePadding>
              ...
              <Link href="#juku" style={{ textDecoration: "none", color: "#4f46e5" }}>
                <Typography variant="body2" sx={{ cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
                  塾・予備校選びと自習の組み合わせ
                </Typography>
              </Link>
        ...
        <Section title="模試の活用法と偏差値の読み方" id="mock">
          ...
          <SubSection title="模試の3つの活用法">
            <List>
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>1. 苦手分野の可視化</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>2. 時間配分の改善</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>3. 志望大学との偏差値比較</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
        ...
        {/* FAQ */}
        <Box sx={{ mb: 5 }}>
          <Typography variant="h2" component="h2" sx={{ fontSize: { xs: "1.2rem", sm: "1.5rem" }, fontWeight: 700, color: "#4f46e5", mb: 3 }}>
            よくあるご質問
          </Typography>
          <FAQ items={faqItems} />
        </Box>
