...
export default function ColumnIndexPage() {
  ...
  const articles = [
    {
      title: "高校生の記憶力向上・記憶術ガイド｜脳科学に基づく暗記法・忘却曲線対策・長期記憶の定着",
      description: "高校生の記憶力向上と効率的な暗記法。短期記憶から長期記憶への移行メカニズム、忘却曲線対策、英単語・古文・歴史の暗記法、記憶術（宮殿法・連想法）、定期テスト後の復習、記憶が苦手な場合の対策を完全解説。",
      href: "/column/koukou-memory-technique/",
      date: "2026-04-07",
    },
    {
      title: "高校生の自学自習ガイド｜効果的な独学方法・学習計画・教材選択・進度管理の完全攻略",
      description: "高校生が自学自習で成功するための完全ガイド。学習目標の設定、教材選択、予習復習のバランス、習慣化、成績が伸びない場合の対処法、塾との併用方法を解説。",
      href: "/column/koukou-self-study/",
      date: "2026-04-07",
    },
    {
      title: "高校生のノート術｜効果的な講義記録・単語帳作成・復習法・教科別ノート術・受験対策",
      description: "高校生が実践すべき効果的なノート術を完全解説。講義記録の基本、教科別ノート術（数学・国語・英語・理科・社会）、復習方法、デジタル活用、受験対策を徹底ガイド。",
      href: "/column/koukou-note-taking/",
      date: "2026-04-07",
    },
    {
      title: "高校生の受験戦略ガイド｜試験対策計画・時間管理・過去問活用・得点力向上・心理的準備",
      description: "高校生の合格に必要な受験戦略を完全解説。3年間のロードマップ、定期テストと受験対策の両立、模試・過去問活用、科目別対策、心理管理、本番試験戦術を徹底ガイド。",
      href: "/column/koukou-exam-strategy/",
      date: "2026-04-07",
    },
    {
      title: "高校生のストレス管理ガイド｜受験期の心理的負担軽減・メンタルヘルス・睡眠・瞑想・相談体制",
      description: "高校生が経験するストレスの原因と対処法。心理的症状、瞑想・マインドフルネス、友人関係・SNSストレス、受験ストレスの向き合い方、相談体制を完全ガイド。",
      href: "/column/koukou-stress-kanri/",
      date: "2026-04-07",
    },
    {
      title: "高校生の時間管理テクニック｜効率的な勉強スケジュール・優先順位・スマートフォン対策・習慣形成",
      description: "高校生が時間を効率的に使う方法。優先順位の決め方、スマートフォン対策、1日の勉強時間配分、テスト対策の時間戦略、習慣形成による長期的な時間管理を完全ガイド。",
      href: "/column/koukou-time-management/",
      date: "2026-04-07",
    },
    {
      title: "高校生の睡眠と学習効率ガイド｜脳の記憶定着と健康的な睡眠時間の確保",
      description: "高校生の睡眠と学力の関係を科学的に解説。理想的な睡眠時間（7～8時間）、睡眠不足による学力低下、脳の記憶定着メカニズム、効果的な就寝・起床時間、スマートフォンの悪影響、受験期の睡眠戦略を完全ガイド。",
      href: "/column/koukou-sleep/",
      date: "2026-04-07",
    },
    {
      title: "高校生の朝の習慣ガイド｜早起き・朝勉強・集中力アップのルーティン",
      description: "高校生が実践すべき朝の習慣（早起き・朝食・朝勉強）で集中力をアップ。理想的な起床時間、朝勉強の効果的な時間配分、朝食の選び方、朝の運動とストレッチ、朝日の重要性、ルーティン崩れからの立て直し方を完全ガイド。",
      href: "/column/koukou-morning-routine/",
      date: "2026-04-07",
    },
    {
      title: "高校1年生の学習ガイド｜先取り学習・予習復習習慣づくり",
      description: "高校1年生が最初の1～2週間でやるべき学習準備、先取り学習のタイミングと効果的な方法、毎日の予習復習習慣の作り方、中学との勉強方法の違いへの適応戦略、定期テストと受験対策の両立、つまずきへの早期対応を完全ガイド。",
      href: "/column/koukou-senbatsu/",
      date: "2026-04-07",
    },
    {
      title: "高校・大学入試面接対策ガイド｜よく聞かれる質問と答え方",
    ...
    {
      title: "通信制高校・オンライン高校の選び方｜卒業資格・学費・自由な時間の両立",
      ...
      href: "/column/koukou-online-school/",
      date: "2026-04-08",
    },
    {
