...
export default function ColumnIndexPage() {
  ...
  const articles = [
    ...
    {
      title: "高校からの進路選択ガイド｜大学・専門学校・就職・起業の選び方とキャリア設計",
