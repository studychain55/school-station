            ...
            <List>
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>テスト8日前～5日前：全教科の範囲確認</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>テスト4日前～2日前：過去問・練習問題に挑戦</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>テスト前日：復習に徹する</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>テスト当日：冷静さを保つ</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
