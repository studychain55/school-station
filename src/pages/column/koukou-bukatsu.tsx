            ...
            <Box sx={{ overflowX: "auto", mb: 3 }}>
              <Paper sx={{ p: 0 }}>
                <Box sx={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", fontSize: "0.85rem" }}>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 1.5, fontWeight: 700 }}>時間帯</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 1.5, fontWeight: 700 }}>体育系部活</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 1.5, fontWeight: 700 }}>文化系部活</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 1.5, fontWeight: 700 }}>部活なし</Box>
