      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Section title="安全校・実力校・チャレンジ校のバランス" id="balance">
          ...
          <SubSection title="受験校の構成例">
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff", mb: 2 }}>
              <Typography variant="body2" sx={{ lineHeight: 1.8, color: "#424242", mb: 2 }}>
        ...
        <Section title="志望校選びで見るべき5つのポイント" id="five-points">
          ...
          <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff", mb: 3 }}>
            <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 2 }}>
        ...
        {/* FAQ */}
        <Box sx={{ mb: 4 }}>
          <Typography variant="h2" component="h2" sx={{ fontSize: "1.3rem", fontWeight: 700, color: "#4f46e5", mb: 3 }}>
            よくある質問
          </Typography>
          <FAQ items={faqItems} />
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          <Divider sx={{ mb: 4 }} />
          <Typography variant="h2" component="h2" sx={{ fontSize: "1.1rem", fontWeight: 700, color: "#4f46e5", mb: 3 }}>
            関連コラム
          </Typography>
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)" }, gap: 2 }}>
            <Link href="/column/hensachi-guide/" style={{ textDecoration: "none" }}>
              <Box sx={{ p: 2, border: "1px solid #E0E0E0", borderLeft: "3px solid #FF6F00", borderRadius: 1, color: "#4f46e5", "&:hover": { bgcolor: "#FFF8E1" } }}>
                偏差値の見方・使い方を徹底解説
              </Box>
            </Link>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <Link href="/column/" style={{ textDecoration: "none" }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, color: "#4f46e5", fontWeight: 600, "&:hover": { opacity: 0.7 } }}>
