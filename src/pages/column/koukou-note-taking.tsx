      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Section title="効果的なノート術の基本原則と講義記録の方法" id="note-basics">
          ...
          <SubSection title="ノート作成の時間配分">
            <Box sx={{ mb: 3, p: 2, bgcolor: "#e0e7ff", borderRadius: 1 }}>
          ...
          <SubSection title="効果的なノート作成のポイント">
            <List sx={{ mb: 3 }}>
              <ListItem><ListItemIcon><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><ListItemText primary="キーワード・図表を優先" secondary="完全な文章は不要、理解に集中することが最優先" /></ListItem>
              <ListItem><ListItemIcon><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><ListItemText primary="左ページに講義内容、右ページに復習用コメント" secondary="ページを二分することで、視認性と復習効率が向上" /></ListItem>
              <ListItem><ListItemIcon><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><ListItemText primary="見出しを階層化する（大見出し・中見出し・小見出し）" secondary="後での検索・復習が容易になり、全体構造が明確" /></ListItem>
              <ListItem><ListItemIcon><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><ListItemText primary="装飾は必要最小限に" secondary="複雑な色分け・図解作成に時間をかけると学習効率が低下" /></ListItem>
            </List>
          </SubSection>
        </Section>
