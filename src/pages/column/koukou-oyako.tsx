        ...
        <Section title="高校受験において保護者の役割とは" id="role">
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)" }, gap: 2, mb: 3 }}>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>情報収集</Typography>
            ...
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>環境整備</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>勉強しやすい家庭環境を整え、健康管理（栄養・睡眠）をサポート。親の役割は『邪魔しない』ことも含まれます。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>メンタルサポート</Typography>
            ...
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>受験の見守り</Typography>
