      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Section title="高校生活の4つの柱" id="pillars">
          ...
          <SubSection title="1. 勉強：将来の基礎を作る">
            <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, border: "1px solid #e0e7ff", mb: 2 }}>
            ...
            <List>
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>朝の時間活用（30～60分）</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>昼休みの活用（20～30分）</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
              ...
              <ListItem disablePadding>
                <Box sx={{ bgcolor: "#e0e7ff", p: 2.5, borderRadius: 1, width: "100%" }}>
                  <Typography sx={{ fontWeight: 700, fontSize: "0.95rem", mb: 0.5, color: "#4f46e5" }}>部活後の勉強（45～60分）</Typography>
                  <Typography variant="body2" sx={{ color: "#424242" }}>
