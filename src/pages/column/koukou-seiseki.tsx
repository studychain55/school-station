      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Section title="内申点（調査書点）とは" id="definition">
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)" }, gap: 2, mb: 3 }}>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>9教科の評定合計</Typography>
            ...
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>高校入試での重要性</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>高校によって内申点と学力試験の比率が異なります。内申点の比率が高い高校では、内申点対策がより重要になります。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>定期テスト重視</Typography>
            ...
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>その他の評価項目</Typography>
        ...
        <Section title="内申点の計算方法" id="calculation">
          ...
          <SubSection title="基本的な計算方法">
            <TableContainer component={Paper} sx={{ mb: 3, border: "1px solid #e0e7ff" }}>
              <Table>
                <TableHead>
        ...
        <Box sx={{ mt: 6, pt: 4, borderTop: "1px solid #E0E0E0" }}>
          <Link href="/column/" style={{ textDecoration: "none" }}>
            <Typography sx={{ color: "#4f46e5", fontWeight: 600, cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
              ← コラム一覧に戻る
            </Typography>
          </Link>
        </Box>
