  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Box sx={{ textAlign: "center", py: { xs: 4, sm: 5 }, mb: 4, background: "linear-gradient(135deg, #4f46e5 0%, #1976D2 50%, #42A5F5 100%)", borderRadius: 3, color: "#fff" }}>
          ...
          <SubSection title="中学との最大の違い">
            <List>
              <ListItem disablePadding sx={{ mb: 1.5 }}>
                <ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon>
          ...
          <SubSection title="高校1年のタイムラインに沿った先取り学習">
            <List>
              <ListItem disablePadding sx={{ mb: 2 }}>
                <ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon>
                <Box>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: "#4f46e5", mb: 0.8 }}>春休み（入学前）</Typography>
              ...
              <ListItem disablePadding sx={{ mb: 2 }}>
                <ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon>
                <Box>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: "#4f46e5", mb: 0.8 }}>高1年4月～7月</Typography>
              ...
              <ListItem disablePadding sx={{ mb: 2 }}>
                <ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon>
                <Box>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: "#4f46e5", mb: 0.8 }}>高1年9月～12月</Typography>
        ...
        <Section title="つまずきの早期発見と対応" id="tsumazuki-taisaku">
          <SubSection title="つまずきの危険信号">
            <List>
              <ListItem disablePadding sx={{ mb: 1.5 }}><ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><Typography variant="body2" sx={{ color: "#424242" }}>授業で「何を言っているかわからない」という状態が2～3日続く</Typography></ListItem>
              <ListItem disablePadding sx={{ mb: 1.5 }}><ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><Typography variant="body2" sx={{ color: "#424242" }}>練習問題で「解き方の流れがわからない」という状態が出現する</Typography></ListItem>
              <ListItem disablePadding sx={{ mb: 1.5 }}><ListItemIcon sx={{ minWidth: 32 }}><CheckCircleIcon sx={{ color: "#4f46e5" }} /></ListItemIcon><Typography variant="body2" sx={{ color: "#424242" }}>予習時に「教科書を読んでもさっぱりわからない」という困惑が生じる</Typography></ListItem>
            </List>
          </SubSection>
        ...
        <Paper elevation={0} sx={{ p: { xs: 3, sm: 4 }, background: "linear-gradient(135deg, #F5F5F5 0%, #EEEEEE 100%)", borderRadius: 2, border: "1px solid #E0E0E0", textAlign: "center" }}>
          <Typography variant="h3" component="h3" sx={{ fontSize: "1.3rem", fontWeight: 700, color: "#4f46e5", mb: 2 }}>
            高校1年の準備が、3年間の成否を決める
          </Typography>
          ...
          <Link href="/column/" style={{ textDecoration: "none" }}>
            <Box sx={{ display: "inline-block", mt: 2, px: 3, py: 1.2, bgcolor: "#4f46e5", color: "#fff", borderRadius: 1, fontWeight: 600, "&:hover": { bgcolor: "#4f46e5" } }}>
              コラム一覧に戻る
            </Box>
          </Link>
        </Paper>
