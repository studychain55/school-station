            ...
            <Box sx={{ overflowX: "auto" }}>
              <Paper sx={{ p: 0 }}>
                <Box sx={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)" }}>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.9rem" }}>項目</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.9rem" }}>学校説明会</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.9rem" }}>オープンキャンパス</Box>
            ...
            <Box sx={{ overflowX: "auto" }}>
              <Paper sx={{ p: 0 }}>
                <Box sx={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)" }}>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.85rem" }}>評価項目</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.85rem" }}>A高校</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.85rem" }}>B高校</Box>
                  <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.85rem" }}>C高校</Box>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr" }, gap: 2, my: 5 }}>
          <Link href="/column/tsushinsei-koukou/" style={{ textDecoration: "none" }}>
            <Paper sx={{ p: 2, border: "1px solid #E0E0E0", textAlign: "center", cursor: "pointer", "&:hover": { boxShadow: 2 } }}>
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1, color: "#4f46e5", fontWeight: 600, fontSize: "0.9rem" }}>
