        ...
        <Section title="高校選びが人生を左右する理由" id="importance">
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)" }, gap: 2, mb: 3 }}>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>学習環境の決定</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>進学校か進学校でない学校か、その選択で受けられる教育内容が大きく異なります。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>人間関係の形成</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>高校での友人関係は、人生に大きな影響を与えます。学校の雰囲気や文化が自分に合っているかが重要です。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>キャリア形成</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>高校の進学実績やキャリア支援の充実度は、将来のキャリア形成に大きく影響します。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>自己成長の機会</Typography>
          ...
          <SubSection title="判断の基準となる3つのポイント">
            <List>
              <ListItem disablePadding sx={{ mb: 2 }}>
                <Box sx={{ bgcolor: "#F5F9FF", p: 2.5, borderRadius: 1, border: "1px solid #e0e7ff", width: "100%" }}>
                  <Typography variant="body2" sx={{ fontWeight: 700, color: "#4f46e5", mb: 1 }}>
                    1. 学力に合致しているか
                  </Typography>
