  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        {/* FAQ Section */}
        <Box sx={{ my: 5 }}>
          <Typography variant="h2" sx={{ fontSize: "1.5rem", fontWeight: 700, color: "#4f46e5", mb: 3 }}>
            よくある質問
          </Typography>
          <FAQ items={faqItems} />
        </Box>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 6, pt: 3, borderTop: "1px solid #ddd" }}>
          <Link href="/column/" style={{ textDecoration: "none" }}>
            <Box sx={{ display: "flex", alignItems: "center", color: "#4f46e5", cursor: "pointer", "&:hover": { textDecoration: "underline" } }}>
