        ...
        <Section title="特待生制度とは" id="tokutasei">
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)" }, gap: 2, mb: 3 }}>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>全額特待生（S特）</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>授業料全額免除。在学中、毎年成績基準をクリアすれば免除が継続されます。最も手厚い支援です。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>半額特待生（A特）</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>授業料の50%を免除。S特より基準はやや緩和されており、多くの高校で数多くの生徒が対象になります。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>部分特待生（B特）</Typography>
              <Typography variant="body2" sx={{ color: "#424242", lineHeight: 1.7 }}>授業料の25％免除、または入学金免除。入学金のみ免除される場合もあります。</Typography>
            </Paper>
            <Paper sx={{ p: 2.5, bgcolor: "#F5F9FF", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, color: "#4f46e5", mb: 1 }}>入学金減免</Typography>
