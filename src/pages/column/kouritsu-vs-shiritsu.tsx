    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Paper sx={{ p: { xs: 2, sm: 3 }, mb: 4, bgcolor: "#F5F5F5", border: "1px solid #E0E0E0" }}>
          <Typography variant="h3" component="h2" sx={{ fontSize: "1.2rem", fontWeight: 700, mb: 2, color: "#4f46e5" }}>
            公立高校と私立高校の基本的な違い
          </Typography>
        ...
        {/* 比較表 */}
        <Box sx={{ mb: 4 }}>
          <Typography variant="h2" component="h2" sx={{ fontSize: { xs: "1.3rem", sm: "1.5rem" }, fontWeight: 700, mb: 3, color: "#4f46e5" }}>
            公立・私立の主要な違い
          </Typography>
              ...
              <TableBody>
                {comparisonData.map((row, idx) => (
                  <TableRow key={idx} sx={{ backgroundColor: idx % 2 === 0 ? "#F5F5F5" : "#fff" }}>
                    <TableCell sx={{ fontWeight: 700, color: "#4f46e5", fontSize: "0.95rem" }}>{row.item}</TableCell>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 3 }}>
            <Paper sx={{ p: 3, bgcolor: "#e0e7ff", border: "1px solid #e0e7ff" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1.1rem", fontWeight: 700, mb: 2, color: "#4f46e5" }}>
                公立高校の学費
              </Typography>
              ...
              <Box sx={{ pt: 2, borderTop: "1px solid #e0e7ff", mt: 2 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 3 }}>
            <Paper sx={{ p: 3, border: "1px solid #E0E0E0" }}>
              <Typography variant="h3" component="h3" sx={{ fontSize: "1rem", fontWeight: 700, mb: 2, color: "#4f46e5" }}>
                公立高校
              </Typography>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(2, 1fr)" }, gap: 3 }}>
            <Paper sx={{ p: 2.5, bgcolor: "#e0e7ff", border: "1px solid #e0e7ff" }}>
              <Typography variant="h4" component="h4" sx={{ fontSize: "1rem", fontWeight: 700, mb: 1.5, color: "#4f46e5" }}>
                公立高校がおすすめの場合
              </Typography>
              <Box component="ul" sx={{ pl: 2 }}>
        ...
        {/* ランキングを確認する */}
        <Box sx={{ my: 4, p: 3, bgcolor: "#e0e7ff", borderRadius: 2, textAlign: "center" }}>
          <Typography variant="h3" component="h3" sx={{ fontSize: "1.1rem", fontWeight: 700, mb: 1, color: "#4f46e5" }}>
            実際に高校の偏差値を確認してみましょう
          </Typography>
