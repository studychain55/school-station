      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Section title="面接対策：よく聞かれる質問と回答のコツ" id="mensetsu">
          ...
          <SubSection title="頻出質問と回答のポイント">
            <Box sx={{ mb: 3 }}>
              <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 1, color: "#4f46e5" }}>1. 「なぜ本校を志望しましたか」</Typography>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 1, color: "#4f46e5" }}>2. 「あなたの長所と短所を教えてください」</Typography>
              <Typography variant="body2" sx={{ color: "#424242", mb: 2 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 1, color: "#4f46e5" }}>3. 「高校に入ってやりたいことは何ですか」</Typography>
              <Typography variant="body2" sx={{ color: "#424242", mb: 2 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 1, color: "#4f46e5" }}>4. 「中学時代の経験で一番成長したことは何ですか」</Typography>
              <Typography variant="body2" sx={{ color: "#424242", mb: 2 }}>
            ...
            <Box>
              <Typography sx={{ fontWeight: 600, fontSize: "0.95rem", mb: 1, color: "#4f46e5" }}>5. 「10年後のあなたを想像してください」</Typography>
              <Typography variant="body2" sx={{ color: "#424242", mb: 2 }}>
