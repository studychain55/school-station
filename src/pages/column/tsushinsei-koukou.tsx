          ...
          <Box sx={{ overflowX: "auto" }}>
            <Paper sx={{ p: 0 }}>
              <Box sx={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)" }}>
                ...
                <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.9rem" }}>通信制高校</Box>
                <Box sx={{ bgcolor: "#4f46e5", color: "#fff", p: 2, fontWeight: 700, fontSize: "0.9rem" }}>定時制高校</Box>
