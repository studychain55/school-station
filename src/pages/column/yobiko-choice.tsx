      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        ...
        <Section title="塾のコスト比較" id="cost-comparison">
          ...
          <Box sx={{ overflowX: "auto", mb: 3 }}>
            <Box sx={{ minWidth: 500, bgcolor: "#F5F9FF", p: 2, borderRadius: 1, border: "1px solid #e0e7ff" }}>
              ...
              <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 2, mb: 2, borderBottom: "1px solid #e0e7ff", pb: 2 }}>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr" }, gap: 2, my: 4 }}>
          <Link href="/column/kokosei-baito/" style={{ textDecoration: "none" }}>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1, color: "#4f46e5" }}>
                <ArrowBackIcon />
