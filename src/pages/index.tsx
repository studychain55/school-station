    ...
    <>
      ...
      <Box sx={{ position: "relative", width: "100%", height: "clamp(280px, 40vw, 440px)" }}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ fontSize: { xs: "0.875rem", md: "1rem" }, opacity: 0.8, mb: 5 }}>
            全国の高校を偏差値・進学実績・特色で比較
          </Typography>
          <Link href="/rankings/koukou/" className="bg-white font-bold px-8 py-3 rounded-full text-sm hover:bg-gray-100 transition-colors shadow-lg" style={{color: '#1e782d'}}>
            高校を探す →
          </Link>
          {/* 都道府県クイックナビ */}
