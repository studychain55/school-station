  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 4 } }}>
        {/* Hero Button Section */}
        <Box sx={{ textAlign: "center", py: 3, mb: 2, display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 2 }}>
          ...
          <Link href="/juku/" style={{ textDecoration: "none" }}>
            <Button
              ...
              sx={{
                borderColor: "#1e782d",
                color: "#1e782d",
                "&:hover": { bgcolor: "#f0f6f0", borderColor: "#155420", transform: "translateY(-1px)" },
                px: 4,
                py: 1.2,
                fontSize: { xs: 14, sm: 16 },
                fontWeight: 700,
