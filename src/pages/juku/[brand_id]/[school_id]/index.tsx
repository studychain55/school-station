        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Box sx={{ position: "sticky", top: 80, display: "flex", flexDirection: "column", gap: 2 }}>
              {/* 問い合わせCTA */}
              <Box sx={{ bgcolor: JUKU_RED, borderRadius: 2, p: 3, color: "#fff", textAlign: "center", boxShadow: "0 4px 16px rgba(183,0,0,0.25)" }}>
                ...
                {school.official_site_url && (
                  <a href={school.official_site_url} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                    <Box sx={{ bgcolor: "#fff", color: JUKU_RED, py: 1.5, borderRadius: 1.5, fontWeight: 800, fontSize: 15, mb: 1.5, "&:hover": { opacity: 0.92 }, transition: "opacity 0.15s" }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                  <Typography sx={{ fontSize: 11, color: "rgba(255,255,255,0.75)", display: "flex", alignItems: "center", justifyContent: "center", gap: 0.5 }}>
                    ✓ 完全無料・会員登録不要
                  </Typography>
                  <Typography sx={{ fontSize: 11, color: "rgba(255,255,255,0.75)", display: "flex", alignItems: "center", justifyContent: "center", gap: 0.5 }}>
                    ✓ 通常2〜3営業日以内にご返信
